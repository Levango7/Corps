...
export default function TaskDetailPage({
  ...
  return (
    <div className="max-w-[var(--container-max)] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-[1fr_220px] lg:grid-cols-[1fr_var(--task-aside-w)] gap-[var(--space-4)] md:gap-[var(--space-5)] lg:gap-[var(--space-6)] items-start">
        {/* ── 主列 ── */}
