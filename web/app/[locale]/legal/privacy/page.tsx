 ...
 * PostgreSQL RLS 多租户隔离、httpOnly cookie 会话。
 */
...
const ZH: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "1. 服务提供商：邮件发送（Resend）、支付处理（Stripe / 支付宝 / 微信）、云基础设施（腾讯云 CloudBase）——仅限其为提供服务所必需的最小范围；",
  ...
  },
  {
    heading: "六、您的权利",
    body: [
      "您有权访问、更正、导出您的个人信息，并可随时在账户设置中修改或删除。行使权利或提出投诉请联系：【待补：隐私事务联系邮箱】。",
    ],
  },
  {
    heading: "七、儿童与生效",
    body: [
      "本服务面向团队协作场景，不面向 14 岁以下儿童。本政策可能不时更新，更新后在本页面发布并更新生效日期。",
    ],
  },
];
...
const EN: Section[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "1. Service providers: email delivery (Resend), payment processing (Stripe / Alipay / WeChat Pay), cloud infrastructure (Tencent CloudBase) — limited to what is necessary;",
  ...
  },
  {
    ...
    body: [
      "You may access, correct, export, or delete your personal information at any time from account settings. To exercise rights or file complaints: [TBD: privacy contact email].",
    ],
  },
  {
    heading: "7. Children & Effectiveness",
    body: [
      "The Service targets team collaboration and is not directed at children under 14. This policy may be updated; new versions are published on this page with a new effective date.",
    ],
  },
];
