...
> 本节评分已移至附录 A（历史快照，2026-08-23 时点）。当前项目状态请以 git 提交记录与 `api/openapi.yaml` 为准。

---

## 附录 A：2026-08-23 时点综合评分（历史快照）

> ⚠️ 本评分仅反映 2026-08-23 时点状态，不代表当前代码。项目此后发生重大变更（IM/日历/附件/i18n/openapi 扩展等），请以 git 提交与 `api/openapi.yaml` 为准。
